    ...
    <Root>
      <div className="FuseSettings-formGroup">
        ...
        <Controller
          ...
          render={({ field }) => (
            <FormControl component="fieldset" className="FuseSettings-formControl">
              ...
              <RadioGroup {...field} aria-label="استایل لایوت" className="FuseSettings-group">
        ...
        <Typography className="my-16 text-12 italic" color="textSecondary">
          *همه ترکیب های گزینه در دسترس نیستند
        </Typography>
      </div>
      ...
      <Controller
        ...
        render={({ field: { onChange, value } }) => (
          <FormControl component="fieldset" className="FuseSettings-formControl">
            <FormLabel component="legend" className="text-14">
              اسکرول بار سفارشی (Custom Scrollbars)
            </FormLabel>
            <Switch
              checked={value}
              onChange={(ev) => onChange(ev.target.checked)}
              aria-label="اسکرول بار کاستوم"
            />
          </FormControl>
        )}
      />
      ...
      <Controller
        ...
        render={({ field }) => (
          <FormControl component="fieldset" className="FuseSettings-formControl">
            ...
            <RadioGroup {...field} aria-label="جهت چیدمان" className="FuseSettings-group" row>
              <FormControlLabel key="rtl" value="rtl" control={<Radio />} label="راست چین" />
              <FormControlLabel key="ltr" value="ltr" control={<Radio />} label="چپ چین" />
            </RadioGroup>
          </FormControl>
        )}
      />
