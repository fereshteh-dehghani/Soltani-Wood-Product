  ...
  switch (user.from) {
    case 'firebase': {
      firebaseService
        .updateUserData(user)
        .then(() => {
          dispatch(showMessage({ message: 'اطلاعات کاربر در  firebase ذخیره شد' }));
        })
        .catch((error) => {
    ...
    case 'auth0': {
      auth0Service
        ...
        .then(() => {
          dispatch(showMessage({ message: 'اطلاعات کاربر در  auth0 ذخیره شد' }));
        })
        .catch((error) => {
          dispatch(showMessage({ message: error.message }));
        });
    ...
    default: {
      jwtService
        .updateUserData(user)
        .then(() => {
          dispatch(showMessage({ message: 'اطلاعات کاربر با api ذخیره شد' }));
        })
        .catch((error) => {
          dispatch(showMessage({ message: error.message }));
        });
