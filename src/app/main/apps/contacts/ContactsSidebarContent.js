      ...
      >
        ...
        <List className="pt-0 px-12">
          ...
          >
            ...
            <ListItemText className="truncate" primary="همه" disableTypography />
          </StyledListItem>
          <StyledListItem
            button
            component={NavLinkAdapter}
          ...
          >
            ...
            <ListItemText className="truncate" primary="پرتکرار" disableTypography />
          </StyledListItem>
          <StyledListItem
            button
            component={NavLinkAdapter}
          ...
          >
            ...
            <ListItemText className="truncate" primary="ستاره دار" disableTypography />
          </StyledListItem>
        </List>
      </Paper>
    </div>
