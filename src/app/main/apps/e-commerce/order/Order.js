  ...
  return (
    <Root
            ...
            <div className="flex flex-1 flex-col items-center sm:items-start">
              ...
              >
                ...
                >
                  ...
                  <span className="mx-4 font-medium">سفارشات</span>
                </Typography>
              </motion.div>
              ...
              <div className="flex flex-col min-w-0 items-center sm:items-start">
                ...
                >
                  ...
                  <Typography variant="caption" className="font-medium">
                    {`از ${order.customer.firstName} ${order.customer.lastName}`}
                  </Typography>
                </motion.div>
              </div>
            </div>
      ...
      contentToolbar={
        ...
        >
          <Tab className="h-64" label="جزئیات سفارش" />
          <Tab className="h-64" label="محصولات" />
          <Tab className="h-64" label="صورت حساب" />
        </Tabs>
      }
      content={
        order && (
