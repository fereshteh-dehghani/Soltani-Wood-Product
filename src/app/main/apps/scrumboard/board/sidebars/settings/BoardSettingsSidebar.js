  ...
  return (
    <div>
      <AppBar position="static">
        <Toolbar className="flex w-full justify-center">تنظیمات اسکرام برد</Toolbar>
      </AppBar>
      ...
      <List className="py-16" dense>
        ...
        >
          ...
          <ListItemText primary="تصاویر کاور کارت" />
        ...
        >
          ...
          <ListItemText primary="Subscribe برد" />
          <ListItemSecondaryAction>
            <Switch
              onChange={() =>
        ...
        <ListItem button onClick={() => dispatch(copyBoard(board))}>
          ...
          <ListItemText primary="کپی کردن برد" />
        </ListItem>
