      ...
      <AppBar position="static" elevation={0}>
        <Toolbar className="flex w-full">
          <Typography variant="subtitle1" color="inherit">
            {eventDialog.type === 'new' ? 'رویداد جدید' : 'ویرایش رویداد'}
          </Typography>
        </Toolbar>
      </AppBar>
          ...
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
              <DateTimePicker
                ...
                onChange={onChange}
                renderInput={(_props) => (
                  <TextField label="شروع" className="mt-8 mb-16 w-full" {..._props} />
                )}
          ...
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
              <DateTimePicker
                ...
                onChange={onChange}
                renderInput={(_props) => (
                  <TextField label="پایان" className="mt-8 mb-16 w-full" {..._props} />
                )}
                minDate={start}
              />
            )}
