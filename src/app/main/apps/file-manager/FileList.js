      ...
      <Table className="simple borderless">
        <TableHead>
          <TableRow>
            ...
            <TableCell className="hidden sm:table-cell">نوع</TableCell>
            <TableCell className="hidden sm:table-cell">ایجادکننده</TableCell>
            <TableCell className="text-center hidden sm:table-cell">سایز</TableCell>
            <TableCell className="hidden sm:table-cell">آخرین اصلاح</TableCell>
          </TableRow>
        </TableHead>
