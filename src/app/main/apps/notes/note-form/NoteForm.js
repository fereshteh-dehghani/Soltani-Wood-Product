    ...
    <div className="flex flex-col w-full">
      ...
      <div className="flex flex-auto justify-between items-center px-16 pb-12">
        <div className="flex items-center">
          ...
          <Tooltip title="افزودن عکس" placement="bottom">
            <div>
              <NoteFormUploadImage
                onChange={(val) =>
          ...
          <Tooltip title="افزودن چک لیست" placement="bottom">
            <IconButton
          ...
          <Tooltip title="تغییر برچسب ها" placement="bottom">
            <div>
              <NoteFormLabelMenu
                note={noteForm}
          ...
          <Controller
            ...
            defaultValue={false}
            render={({ field: { onChange, value } }) => (
              <Tooltip title={value ? 'لغو بایگانی' : 'بایگانی'} placement="bottom">
                <div>
                  <IconButton
                    className="w-32 h-32 mx-4 p-0"
