        ...
        <div className="p-12 md:p-24 max-w-2xl">
          <div>
            <Typography className="mb-8" variant="h5">
              استایل دهی در Material-UI
            </Typography>

            <Typography className="mb-16" component="p">
              قالب Fuse React
              بر اساس کتابخونه ی Material-UI
              توسعه داده شده است
              <br />
              <a
                className="mx-4"
              ...
              >
                استایل های Material-UI
              </a>
              از emotion در هسته ی خودش استفاده میکنه
              <br />
              پس میشه گفت درواقع این قالب از
