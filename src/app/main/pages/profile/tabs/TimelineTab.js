            ...
            >
              <CardHeader
                ...
                title={
                  <span className="flex">
                    ...
                    <span className="mx-4">
                      {post.type === 'post' && 'در تایم لاین شما پست کرد'}
                      {post.type === 'something' && 'چیزی را با شما به اشتراک گذاشت'}
                      {post.type === 'video' && 'یک ویدئو با شما به اشتراک گذاشت'}
                      {post.type === 'article' && 'یک مقاله با شما اشتراک گذاشت'}
                    </span>
                  </span>
                }
                subheader={post.time}
              ...
              <CardActions disableSpacing className="px-12">
                <Button size="small" aria-label="Add to favorites">
                  ...
                  <Typography className="mx-4">لایک</Typography>
                ...
                <Button aria-label="Share">
                  ...
                  <Typography className="mx-4">اشتراک گذاری</Typography>
                ...
                {post.comments && post.comments.length > 0 && (
                  <div className="">
                    <div className="flex items-center">
                      <Typography>{post.comments.length} دیدگاه</Typography>
